...
public class LiquidacionModel {
    ...
    //Id para la base de datos en MongoDB
    @Id
    private Long id;
    
    //variables del input formulario
    ...
    private Boolean despidoinjustificado;
        ...
        //Variables a Calcular (OUTPUT)
    //Salio Completo
    
    private String totalsalario;
    ...
    public void setTotalsalario(String totalsalario) {
